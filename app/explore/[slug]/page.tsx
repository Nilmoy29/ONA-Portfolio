...
export default function ExploreDetailPage() {
  ...
  const formatContent = (content: string) => {
    return content.split('\n').map((paragraph, index) => (
      <p key={index} className="text-lg text-zinc-300 font-light leading-relaxed mb-6">
        {paragraph}
      </p>
    ))
  }
        ...
        <div className="pt-32 pb-20 px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="animate-pulse">
              <div className="h-16 bg-zinc-800 rounded mb-6"></div>
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <div className="pt-32 pb-20 px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-zinc-400 mb-8">The content you're looking for doesn't exist.</p>
            <Link href="/explore">
              <button className="flex items-center space-x-2 text-lg font-light uppercase tracking-wider border-b border-zinc-600 pb-2 hover:text-[#ff6b00] hover:border-[#ff6b00] transition-colors">
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="pt-32 pb-8 px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <Link href="/explore">
            <motion.button
              className="flex items-center space-x-2 text-lg font-light uppercase tracking-wider text-zinc-300 hover:text-[#ff6b00] transition-colors group"
          ...
          >
            ...
            >
              ...
              {content.featured_image_url && (
                <motion.div
                  className="bg-zinc-900 rounded-2xl shadow-xl overflow-hidden border border-zinc-800 mb-8"
              ...
              {/* Content Card */}
              <motion.article
                className="bg-zinc-900 rounded-2xl shadow-lg p-8 lg:p-12 border border-zinc-800"
              ...
              >
                ...
                {content.excerpt && (
                  <p className="text-xl text-zinc-300 font-light leading-relaxed mb-8 pb-8 border-b border-zinc-800">
                    {content.excerpt}
                  </p>
                )}
            ...
            >
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-light capitalize text-zinc-200">{content.content_type}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-light text-zinc-200">{formatDate(content.created_at)}</p>
                    </div>
                  </div>
                  {content.author && (
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="font-light text-zinc-200">{content.author.full_name}</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              >
                ...
                <p className="text-sm text-zinc-400 mb-4">Get the latest insights delivered to your inbox.</p>
                <motion.button
                  className="w-full px-4 py-2 bg-zinc-900 text-white rounded-lg font-light hover:bg-zinc-800 transition-colors"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  Subscribe
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            >
              <motion.div 
                variants={itemVariants}
                className="w-20 h-20 bg-zinc-800 rounded-full overflow-hidden flex-shrink-0"
              >
                <Image
                ...
                {relatedContent.filter((item: any) => item.slug !== content.slug).slice(0, 3).map((item: any) => (
                  ...
                  >
                    <Link href={`/explore/${item.slug}`}>
                      <div className="h-48 bg-black rounded-lg mb-6 flex items-center justify-center">
                        <Image
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center space-x-4 text-xs text-zinc-500 font-light uppercase tracking-wider">
                        ...
                        <h3 className="text-xl font-light group-hover:text-[#ff6b00] transition-colors">
                          {item.title}
                        </h3>
                        
                        <p className="text-zinc-400 font-light leading-relaxed line-clamp-3">
                          {item.excerpt}
                        </p>
                        
                        <div className="flex items-center space-x-2 text-sm text-zinc-400 group-hover:text-[#ff6b00] transition-colors">
                          <span>Read More</span>
